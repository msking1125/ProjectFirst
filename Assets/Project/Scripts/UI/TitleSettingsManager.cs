...
namespace Project
{
    public class TitleSettingsManager : MonoBehaviour
    {
        ...
        {
            if (settingsPanel != null || targetCanvas == null)
            {
                return;
            }
        ...
        private static void SetFullScreenStretch(RectTransform rt)
        {
        ...
        private void LoadSettings()
        {
            ...
            if (bgmSlider != null)
            {
                bgmSlider.SetValueWithoutNotify(Mathf.Clamp(bgm, 0, 100));
            }
            if (sfxSlider != null)
            {
                sfxSlider.SetValueWithoutNotify(Mathf.Clamp(sfx, 0, 100));
            }
            if (muteToggle != null)
            {
