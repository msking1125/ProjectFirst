    ...
    public static void Import()
    {
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            if (effectTypeIdx >= 0)
            {
                ...
                if (Enum.TryParse(etRaw, true, out SkillEffectType et))
            ...
            if (buffStatIdx >= 0 && Enum.TryParse(GetCell(cols, buffStatIdx), true, out BuffStatType bs))
            ...
            if (debuffTypeIdx >= 0 && Enum.TryParse(GetCell(cols, debuffTypeIdx), true, out DebuffType dt))
